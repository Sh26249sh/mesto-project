/*import {nameProfile,jobProfile,jobInput,popupProfile,nameInput,esc} from '../index.js';
...
export function handleCargFormSubmit (evt) { // ф-ия сохраняем данные в форме редактирования профиля и закрываем его 
  evt.preventDefault();
  nameProfile.textContent=nameInput.value;
  jobProfile.textContent=jobInput.value;
  closePopup(popupProfile); 
